...
function TampilkanJenisLabel(){
  ...
  CheckFormScript("DariNPM,SampaiNPM");
	echo "<p><table class=box cellpadding=4 cellspacing=1>
				...
				<tr><td class=inp>1.</td><td class=ul>Label Map untuk Absen</td><td class=ul><a href=cetak.label.jdwl.php?tahun=$_SESSION[tahun]&prodi=$_SESSION[prodi]&prid=$_SESSION[prid]><img src=img/printer.gif></a></td></tr>
				<tr><td class=inp>2.</td><td class=ul>Label untuk Disket Nilai</td><td class=ul><a href=cetak.label.disket.php?tahun=$_SESSION[tahun]&prodi=$_SESSION[prodi]&prid=$_SESSION[prid]><img src=img/printer.gif></a></td></tr>
